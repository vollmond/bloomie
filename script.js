document.addEventListener('DOMContentLoaded', () => {
    ...
    const contentData = {
        ...
        "contacto": {
            ...
            text: "Estamos à sua disposição! Contacte-nos para agendar a sua avaliação ou tratamento através do nosso email:<br><a href='mailto:contacto@bloomestetica.pt' class='email-link'>contacto@bloomestetica.pt</a><br><br><hr class='contact-divider'><br>Ou, se preferir, envie-nos uma mensagem instantânea:<br><br><a href='https://wa.me/351920743163' target='_blank' class='whatsapp-link'>💬 Falar no WhatsApp</a>"
